...
BASKETBALLGAME_API UClass* Z_Construct_UClass_ACombatEnemy();
BASKETBALLGAME_API UClass* Z_Construct_UClass_ACombatEnemy_NoRegister();
BASKETBALLGAME_API UClass* Z_Construct_UClass_UCombatAttacker_NoRegister();
BASKETBALLGAME_API UClass* Z_Construct_UClass_UCombatDamageable_NoRegister();
BASKETBALLGAME_API UClass* Z_Construct_UClass_UCombatLifeBar_NoRegister();
...
struct Z_Construct_UDelegateFunction_BasketBallGame_OnEnemyDied__DelegateSignature_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_BasketBallGame_OnEnemyDied__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_BasketBallGame, nullptr, "OnEnemyDied__DelegateSignature", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_BasketBallGame_OnEnemyDied__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_BasketBallGame_OnEnemyDied__DelegateSignature_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UDelegateFunction_BasketBallGame_OnEnemyDied__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_BasketBallGame_OnEnemyDied__DelegateSignature_Statics::FuncParams);
	}
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ACombatEnemy_Statics::NewProp_OnEnemyDied = { "OnEnemyDied", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACombatEnemy, OnEnemyDied), Z_Construct_UDelegateFunction_BasketBallGame_OnEnemyDied__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnEnemyDied_MetaData), NewProp_OnEnemyDied_MetaData) }; // 2047269347
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ACombatEnemy_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UCombatAttacker_NoRegister, (int32)VTABLE_OFFSET(ACombatEnemy, ICombatAttacker), false },  // 1072802122
	{ Z_Construct_UClass_UCombatDamageable_NoRegister, (int32)VTABLE_OFFSET(ACombatEnemy, ICombatDamageable), false },  // 3687531711
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_ClimbingGame_BasketballGameNew_Basketball_New_Repo_2_BasketballGame_Source_BasketBallGame_Variant_Combat_AI_CombatEnemy_h__Script_BasketBallGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACombatEnemy, ACombatEnemy::StaticClass, TEXT("ACombatEnemy"), &Z_Registration_Info_UClass_ACombatEnemy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACombatEnemy), 3339610156U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ClimbingGame_BasketballGameNew_Basketball_New_Repo_2_BasketballGame_Source_BasketBallGame_Variant_Combat_AI_CombatEnemy_h__Script_BasketBallGame_1982482734(TEXT("/Script/BasketBallGame"),
	Z_CompiledInDeferFile_FID_ClimbingGame_BasketballGameNew_Basketball_New_Repo_2_BasketballGame_Source_BasketBallGame_Variant_Combat_AI_CombatEnemy_h__Script_BasketBallGame_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ClimbingGame_BasketballGameNew_Basketball_New_Repo_2_BasketballGame_Source_BasketBallGame_Variant_Combat_AI_CombatEnemy_h__Script_BasketBallGame_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
