...
// ********** Begin Class ABasketBallGamePlayerController Function RefreshHUD **********************
struct Z_Construct_UFunction_ABasketBallGamePlayerController_RefreshHUD_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Refresh HUD with latest gameplay snapshot (called by GameMode after scoring events) */" },
#endif
		{ "ModuleRelativePath", "BasketBallGamePlayerController.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Refresh HUD with latest gameplay snapshot (called by GameMode after scoring events)" },
#endif
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ABasketBallGamePlayerController_RefreshHUD_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_ABasketBallGamePlayerController, nullptr, "RefreshHUD", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ABasketBallGamePlayerController_RefreshHUD_Statics::Function_MetaDataParams), Z_Construct_UFunction_ABasketBallGamePlayerController_RefreshHUD_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UFunction_ABasketBallGamePlayerController_RefreshHUD()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ABasketBallGamePlayerController_RefreshHUD_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(ABasketBallGamePlayerController::execRefreshHUD)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->RefreshHUD();
...
// ********** End Class ABasketBallGamePlayerController Function RefreshHUD ************************
...
void ABasketBallGamePlayerController::StaticRegisterNativesABasketBallGamePlayerController()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "RefreshHUD", &ABasketBallGamePlayerController::execRefreshHUD },
	};
...
struct Z_Construct_UClass_ABasketBallGamePlayerController_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BasketballHUD_MetaData[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Typed reference to Basketball HUD (C++ base widget) */" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "BasketBallGamePlayerController.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Typed reference to Basketball HUD (C++ base widget)" },
#endif
	};
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_BasketballHUD;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_ABasketBallGamePlayerController_RefreshHUD, "RefreshHUD" }, // 1152786574
	};
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_ABasketBallGamePlayerController_Statics::NewProp_ScoreHUDClass = { "ScoreHUDClass", nullptr, (EPropertyFlags)0x0024080000010001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ABasketBallGamePlayerController, ScoreHUDClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ScoreHUDClass_MetaData), NewProp_ScoreHUDClass_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABasketBallGamePlayerController_Statics::NewProp_ScoreHUD = { "ScoreHUD", nullptr, (EPropertyFlags)0x0020080000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ABasketBallGamePlayerController, ScoreHUD), Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ScoreHUD_MetaData), NewProp_ScoreHUD_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABasketBallGamePlayerController_Statics::NewProp_BasketballHUD = { "BasketballHUD", nullptr, (EPropertyFlags)0x0020080000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ABasketBallGamePlayerController, BasketballHUD), Z_Construct_UClass_UBasketballHUDWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BasketballHUD_MetaData), NewProp_BasketballHUD_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABasketBallGamePlayerController_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABasketBallGamePlayerController_Statics::NewProp_BasketballHUD,
...
struct Z_CompiledInDeferFile_FID_ClimbingGame_BasketballGameNew_Basketball_New_Repo_2_BasketballGame_Source_BasketBallGame_BasketBallGamePlayerController_h__Script_BasketBallGame_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ABasketBallGamePlayerController, ABasketBallGamePlayerController::StaticClass, TEXT("ABasketBallGamePlayerController"), &Z_Registration_Info_UClass_ABasketBallGamePlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABasketBallGamePlayerController), 2978193296U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ClimbingGame_BasketballGameNew_Basketball_New_Repo_2_BasketballGame_Source_BasketBallGame_BasketBallGamePlayerController_h__Script_BasketBallGame_1273259332(TEXT("/Script/BasketBallGame"),
