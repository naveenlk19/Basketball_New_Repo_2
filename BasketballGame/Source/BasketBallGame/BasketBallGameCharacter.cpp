...
void ABasketBallGameCharacter::PickupBall(const FInputActionValue& Value)
{
	if (BallHandler)
	{
		if (!BallHandler->TryPickupBall())
		{
			BallHandler->DropBall();
		}
	}
}
...
void ABasketBallGameCharacter::DoMove(float Right, float Forward)
{
...
void ABasketBallGameCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ABasketBallGameCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ABasketBallGameCharacter::DoJumpEnd()
{
